...
Route::get('/contact', [\App\Modules\SEO\Http\Controllers\ContactController::class, 'show'])->name('contact');
Route::post('/contact', [\App\Modules\SEO\Http\Controllers\ContactController::class, 'submit']);
