...
@section('title', "$division->name Division — ILMATLAS")
        ...
        <div class="mb-8">
            ...
            <div class="flex flex-wrap gap-2">
                @foreach($districts as $district)
                    <a href="{{ route('locations.district', $district) }}" class="px-4 py-2 bg-gray-100 rounded-lg text-sm text-gray-700 hover:bg-indigo-100 hover:text-indigo-700">{{ $district->name }}</a>
                @endforeach
            </div>
        </div>
    @endif
